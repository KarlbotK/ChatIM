package com.goat.redpacketservice.config;
...
public class RedisConfig {
     ...
     * 抢红包 Lua 脚本
     * <p>
     * KEYS[1]: 红包金额池 List Key (使用 {@link com.goat.redpacketservice.constant.RedisKeyConstant#POOL_TEMPLATE})
     * KEYS[2]: 已领取记录 Hash Key (使用 {@link com.goat.redpacketservice.constant.RedisKeyConstant#RECORDS_TEMPLATE})
     * ARGV[1]: 当前用户ID (userId)
     * <p>
     * 返回值 (参见 {@link com.goat.redpacketservice.constant.ReceiveResultConstant}):
     * <ul>
     ...
     * 扫描过期红包 Lua 脚本
     * <p>
     * KEYS[1]: 过期任务的 ZSet 键名 (使用 {@link com.goat.redpacketservice.constant.RedisKeyConstant#EXPIRE_ZSET})
