package com.goat.userservice.scheduler;

import java.util.Collections;
import java.util.List;

import com.goat.userservice.constants.KafkaTopicConstant;
import com.goat.userservice.model.dto.FriendRequestExpirationEvent;
...
public class FriendRequestExpirationDispatcher {
    ...
    @SchedulerLock(
            ...
            lockAtLeastFor = "200ms"   // 至少锁定200ms
    )
