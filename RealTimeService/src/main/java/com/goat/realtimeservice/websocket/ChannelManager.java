...
public class ChannelManager {
    ...
    public static String removeChannelUser(Channel channel) {
        return CHANNEL_USER_MAP.remove(channel);
    }

    public static boolean removeUserChannel(String userId, Channel channel) {
        return USER_CHANNEL_MAP.remove(userId, channel);
    }
